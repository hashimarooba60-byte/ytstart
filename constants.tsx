...
export const MOCK_COMMENTS: Comment[] = Array.from({length: 15}).map((_, i) => ({
    id: `comment_${i + 1}`,
    authorName: `User${100+i}`,
    authorAvatarUrl: `https://picsum.photos/seed/user${i}/40/40`,
    text: `This is an amazing video! I learned so much. Can't wait for the next part. Keep up the great work. This is comment #${i+1}.`,
    likes: Math.floor(Math.random() * 2000),
    postedAt: `${i+2} hours ago`
}));